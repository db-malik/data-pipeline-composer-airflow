...
def load_transformed_data():
    ...
    SELECT CAST (SaleID as INTEGER), CAST(ProductID as STRING) , CAST(quantity AS INTEGER),  CAST(Price AS FLOAT64), CAST(SaleDate AS DATE),CAST(quantity AS FLOAT64) * CAST(price AS FLOAT64) AS total_price
